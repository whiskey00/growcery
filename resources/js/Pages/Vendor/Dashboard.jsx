...
export default function Dashboard({ 
    ...
    recentOrders, 
    averageRating = 4.5, 
    ratingDistribution = {1: 2, 2: 5, 3: 10, 4: 25, 5: 40}, 
    recentReviews = [] 
}) {
        ...
        <VendorLayout>
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="grid gap-4 sm:gap-6 grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="bg-white rounded-lg shadow p-4 sm:p-6 flex flex-col">
                        <div className="flex flex-col sm:flex-row sm:items-center flex-grow">
                            ...
                            <div className="sm:ml-4">
                                ...
                                {thisMonthSales > 0 && (
                                    <p className="text-xs text-green-600 mt-1">+₱{Number(thisMonthSales).toLocaleString()} this month</p>
                                )}
                            </div>
                        </div>
                        <div className="mt-auto pt-3 sm:pt-4">
                            <Link href="/vendor/orders" className="inline-block w-full text-center bg-green-50 hover:bg-green-100 text-green-700 px-3 py-2 rounded-md text-xs sm:text-sm font-medium transition-colors">View Sales →</Link>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow p-4 sm:p-6 flex flex-col">
                        <div className="flex flex-col sm:flex-row sm:items-center flex-grow">
                            ...
                            <div className="sm:ml-4">
                                ...
                                {thisMonthOrders > 0 && (
                                    <p className="text-xs text-blue-600 mt-1">+{thisMonthOrders} this month</p>
                                )}
                            </div>
                        </div>
                        <div className="mt-auto pt-3 sm:pt-4">
                            <Link href="/vendor/orders" className="inline-block w-full text-center bg-blue-50 hover:bg-blue-100 text-blue-700 px-3 py-2 rounded-md text-xs sm:text-sm font-medium transition-colors">{t('vendor.dashboard.viewAllOrders')} →</Link>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow p-4 sm:p-6 flex flex-col">
                        <div className="flex flex-col sm:flex-row sm:items-center flex-grow">
                            <div className="p-2 sm:p-3 rounded-full bg-indigo-100 text-indigo-600 mb-3 sm:mb-0">
                                <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="mt-auto pt-3 sm:pt-4">
                            <Link href="/vendor/products" className="inline-block w-full text-center bg-indigo-50 hover:bg-indigo-100 text-indigo-700 px-3 py-2 rounded-md text-xs sm:text-sm font-medium transition-colors">Manage Products →</Link>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow p-4 sm:p-6 flex flex-col">
                        ...
                        <div className="mt-auto pt-3 sm:pt-4">
                            <Link href="/vendor/reviews" className="inline-block w-full text-center bg-purple-50 hover:bg-purple-100 text-purple-700 px-3 py-2 rounded-md text-xs sm:text-sm font-medium transition-colors">View Reviews →</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                    {/* Low Stock Alert */}
                    {lowStockProducts > 0 && (
                        <div className="bg-white rounded-lg shadow p-4 sm:p-6 border-l-4 border-orange-400">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-lg font-semibold text-orange-600">{lowStockProducts} products</p>
                    ...
                    <div className="bg-white rounded-lg shadow p-4 sm:p-6">
                        ...
                        <div className="space-y-3">
                            <Link href="/vendor/products/create" className="flex items-center text-sm text-green-600 hover:text-green-700">
                                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                </svg>
                                Add Product
                            </Link>
                            <Link href="/vendor/orders" className="flex items-center text-sm text-blue-600 hover:text-blue-700">
                                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                                </svg>
                                View Orders
                            </Link>
                            <Link href="/vendor/products" className="flex items-center text-sm text-indigo-600 hover:text-indigo-700">
                                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                </svg>
                                Manage Products
                    ...
                    <div className="bg-white rounded-lg shadow p-4 sm:p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-lg font-semibold text-gray-900">{bestSelling}</p>
                                <p className="text-xs text-gray-500">Top performing product</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-3">
                    ...
                    {/* Rating Distribution */}
                    <div className="bg-white shadow rounded-lg p-4 sm:p-6">
                        <h2 className="text-base sm:text-lg font-medium text-gray-900 mb-4">{t('vendor.reviews.ratingDistribution')}</h2>
                        <div className="h-[250px] sm:h-[300px]">
                            <Bar 
                                data={ratingData} 
                                options={{ 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div className="text-center p-4 bg-green-50 rounded-lg">
                            <div className="text-2xl font-bold text-green-600 mb-2">
                                {topSelling.length > 0 ? topSelling[0].orders : 0}
                            </div>
                            <div className="text-sm text-green-700">Most Popular Product Orders</div>
                        </div>
                        <div className="text-center p-4 bg-blue-50 rounded-lg">
                            <div className="text-2xl font-bold text-blue-600 mb-2">
                                ₱{Number(thisMonthSales).toLocaleString()}
                            </div>
                        ...
                        <div className="text-center p-4 bg-purple-50 rounded-lg">
                            ...
                            <div className="text-sm text-purple-700">Average Customer Rating</div>
                        </div>
                    </div>
                </div>
