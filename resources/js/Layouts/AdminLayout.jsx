            ...
            <div className="w-64 bg-gray-800 text-white flex flex-col justify-between p-5 md:w-1/4 lg:w-1/5">
                <div>
                    ...
                    <ul>
                        ...
                        <li className="mb-4">
                            <Link href="/admin/categories" className="text-white hover:bg-gray-700 p-2 rounded block">Categories</Link>
                        </li>
                        <li className="mb-4">
                            <Link href="/admin/orders" className="text-white hover:bg-gray-700 p-2 rounded block">Orders</Link>
                        </li>
                        <li className="mb-4">
                            <Link href="/admin/vendor-applications" className="text-white hover:bg-gray-700 p-2 rounded block">Vendor Applications</Link>
                        </li>
                        <li className="mb-4">
